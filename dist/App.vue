  ...
  <div id="app">
    ...
    <div class="row" id="eventEdit">
      ...
      <form class="col s12" @submit.prevent="addEvent">
        ...
        <button id="eventEditSubmit" class="btn" type="submit">
...
export default {
  ...
  methods: {
    addEvent() {
      const event = {
        ...
        startTime: this.startTime
          ? moment(this.startTime).format('YYYY-MM-DD HH:mm:00')
          : null,
        endDate: this.endDate
          ? moment(this.endDate).format('YYYY-MM-DD')
          : null,
        endTime: this.endTime
          ? moment(this.endTime).format('YYYY-MM-DD HH:mm:00')
          : null,
        title: this.title,
    ...
    confirmDeleteEvent(id) {
      ...
      this.selectedEvent = `'${event.title}' on ${event.startDate}${
